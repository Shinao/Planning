...
?>
	    ...
	    <!-- <div id="footer"> -->
		   <!-- <p id="copyright">Copyright � 2011&#45;2012 &#45; Rapha�l MONNERAT &#45; Aucun droits r�serv�s</p> -->
	    <!-- </div> -->
	</div>
	<div id="javascriptError">
	    <div id="title">Erreur</div>
	    <div id="text">Javascript n'est pas activ�, le site ne peut fonctionner correctement</div>
	</div>
<script>
